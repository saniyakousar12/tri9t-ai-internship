...
Design and decision record for the document extraction, version-matching, and LLM-based test-case generation pipeline built for the CT-200 device manual.

## Table of Contents

- [1. PDF Parsing Strategy](#1-pdf-parsing-strategy)
  - [Selected Approach](#selected-approach-pdfplumber--custom-hierarchy-builder)
  - [Parsing Pipeline](#parsing-pipeline)
  - [Heading Detection](#heading-detection)
  - [Hierarchy Reconstruction](#hierarchy-reconstruction)
  - [Structural Irregularities Found](#structural-irregularities-actually-found-in-the-ct-200-manual)
  - [Initial Implementation Failures](#what-the-initial-implementation-failed-to-handle)
  - [How Failures Were Identified](#how-the-failures-were-identified)
  - [Extraction Quality Improvements](#changes-made-to-improve-extraction-quality)
- [2. Version Matching Strategy](#2-version-matching-strategy)
  - [Primary: Path-Based Matching](#primary-path-based-matching)
  - [Fallback: Fuzzy Title Matching](#fallback-fuzzy-title-matching)
  - [Content Hash](#content-hash)
  - [Known Failure Modes](#known-failure-modes-specific-to-ct-200-v1v2)
- [3. LLM Prompt Design](#3-llm-prompt-design)
  - [Prompt Template](#prompt-template)
  - [Why This Design](#why-this-design)
  - [Validation & Error Handling](#structured-output-validation--error-handling)
  - [Duplicate Submission Policy](#duplicate-submission-policy)
- [4. Staleness / Impact Detection](#4-staleness--impact-detection)
  - [Approach: Content Hash Comparison](#approach-content-hash-comparison)
  - [Staleness States](#staleness-states)
  - [Honest Limits of This Approach](#honest-limits-of-this-approach)
- [5. Data Model](#5-data-model)
  - [Relational Store](#relational-store-sqlite-via-sqlalchemy)
  - [NoSQL Store](#nosql-store--llm-generated-output)
- [6. Decision Log](#6-decision-log)
- [7. What I'd Do Differently With More Time](#7-what-id-do-differently-with-more-time)
